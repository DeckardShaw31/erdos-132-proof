...
\section{Resolution for $n = 7$ and $n = 8$}
...
Multi-start quasi-Newton optimization (L-BFGS-B, 50 restarts) establishes strictly positive infima for all candidate partitions:

\begin{table}[ht]
\centering
\caption{Optimization results for candidate partitions of $n = 7$ and $n = 8$.}
\begin{tabular}{@{}lccc@{}}
\toprule
...
\begin{theorem}
Every set of $n \in \{7, 8\}$ points in $\mathbb{R}^2$ determines at least two rare distances.
\end{theorem}
